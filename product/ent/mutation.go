...
func (m *ProductMutation) SetUserName(s string) {
	m.user_name = &s
}

// UserName returns the value of the "user_name" field in the mutation.
func (m *ProductMutation) UserName() (r string, exists bool) {
	v := m.user_name
	if v == nil {
		return
	}
...
// OldUserName returns the old "user_name" field's value of the Product entity.
// If the Product object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProductMutation) OldUserName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ProductMutation) ResetUserName() {
	m.user_name = nil
}
...
func (m *ProductMutation) Fields() []string {
	...
	if m.user_name != nil {
		fields = append(fields, product.FieldUserName)
	}
	if m.created_at != nil {
